...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status in ("administrator", "creator"):
        message.reply_text("☛ Aᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ᴍᴇ ᴛʜᴀᴛ ᴜsᴇʀ ɪs ᴀʟʀᴇᴀᴅʏ ᴀɴ ᴀᴅᴍɪɴ ʜᴇʀᴇ !")
        return
    ...
    log_message = (
        ...
        f"<b>❄️ ᴜsᴇʀ :</b> {mention_html(user_member.user.id, user_member.user.first_name)}"
    )
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        log_message = (
            ...
            f"<b>❄️ ᴅᴇᴍᴏᴛᴇᴅ :</b> {mention_html(user_member.user.id, user_member.user.first_name)}"
        )
        ...
        try:
            ...
            msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("» Mᴇssᴀɢᴇ «", url=f"{message_link}")]]
                ),
                parse_mode=ParseMode.HTML,
    ...
    if match:
        ...
        if demoted:
            ...
            return (
                ...
                f"#DEMOTE\n"
                f"<b>🥂ᴅᴇᴍᴏᴛᴇʀ :</b> {mention_html(user.id, user.first_name)}\n"
                f"<b>❄️ ᴜsᴇʀ :</b> {mention_html(member.user.id, member.user.first_name)}"
            )
    else:
        update.effective_message.edit_text(
...
**𝑇ℎ𝑒 𝐹𝑜𝑙𝑙𝑜𝑤𝑖𝑛𝑔 𝐶𝑜𝑚𝑚𝑎𝑛𝑑𝑠 𝑎𝑟𝑒 𝐴𝑑𝑚𝑖𝑛𝑠 𝑜𝑛𝑙𝑦 :** 
